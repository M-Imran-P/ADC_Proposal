...
s = replace_section(s, '{/* ===== SECTION 9: DOORS & WINDOWS ===== */}', '{/* ===== PAGE 6: SECTIONS 10, 11 & 12 ===== */}', sec9)
s = replace_section(s, '{/* ===== SECTION 10: PAINTING ===== */}', '{/* ===== SECTION 11: ELECTRICAL ===== */}', sec10)
s = replace_section(s, '{/* ===== SECTION 11: ELECTRICAL ===== */}', '{/* ===== SECTION 12: WATER STORAGE ===== */}', sec11)

assert 'CPVC SDR 11 — Ashirwad / Supreme / Astral or equivalent.' in s
assert 'CPVC Class B (4 kg) SDR 11' not in s
assert 'Dr. Fixit / Fosroc + chemical waterproofing system' in s
assert s.index('id="sec-7"') < s.index('id="sec-6"')
assert 'Architectural drawing' in s and 'MEP Drawing' in s
